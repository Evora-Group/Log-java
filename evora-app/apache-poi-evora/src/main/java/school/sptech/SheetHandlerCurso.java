...
public class SheetHandlerCurso extends SheetHandler{
    ...
    public SheetHandlerCurso(SharedStringsTable sst, InstituicaoDao instituicaoDao, int anoFiltro, String ufFiltro) {
        super(sst);
